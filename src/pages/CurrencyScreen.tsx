          ...
          <div className="unity-inspector mb-8">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                {/* Market Cap */}
                <div className="game-ui-card border-blue-900/60 hover:border-blue-900">
                  <div className="unity-tab active bg-blue-900/20 border-b border-blue-900/40 px-3 py-2">
                    <div className="flex items-center space-x-2">
                      <BarChart3 className="w-3 h-3 text-blue-900" />
                      <span className="text-xs font-mono font-bold text-gray-300">MARKET CAP</span>
                    </div>
                  </div>
                  <div className="p-4 text-center">
                    <div className="text-2xl font-bold text-blue-900 font-mono mb-1">
                      {marketCap}
                    </div>
                    ...
                    <div className="unity-panel p-4">
                      <div className="flex justify-between items-center mb-2">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-blue-900 font-mono font-bold">ADA</span>
                        </div>
                        <span className="text-blue-900 text-xs font-mono">CARDANO</span>
                      </div>
                      <div className="text-right">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="unity-panel p-3">
                      <div className="flex items-center space-x-3">
                        <div className="text-lg">🛒</div>
                        <div>
                          <div className="text-sm text-blue-900 font-mono font-bold mb-1">IN-GAME PURCHASES</div>
            ...
            <div className="unity-inspector">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="game-ui-card p-4 text-center">
                    <div className="text-2xl mb-2">🌊</div>
                    <div className="text-sm text-blue-900 font-mono font-bold mb-1">SUNDAESWAP</div>
                    <div className="text-xs text-gray-400 font-mono">Available</div>
                  </div>
